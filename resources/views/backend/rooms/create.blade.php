        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="row">
                    <div class="col-12 ">
                        <div class="card">
                            <form class="needs-validation" novalidate="" action={{ route('backend.room.store') }} method="POST"  >
                                @csrf
                                ...
                                <div class="card-body ">
                                    <div class="form-group">
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" class="form-control" name="room_id" required autofocus  value="{{old('room_id')}}"/>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row mb-4 ">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" class="form-control" name="status" required autofocus  value="{{old('status')}}"/>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row mb-4" id="datepicker">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" class="form-control " name="computer_number" required autofocus value="{{old('computer_number')}}"/>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row mb-4" id="datepicker">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" class="form-control " name="address" required autofocus value="{{old('address')}}"/>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row mb-4" id="datepicker"><label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Môn học</label>
                                            <div class="col-sm-12 col-md-7">
                                                <select class="form-control select2" id="select2" multiple="" name="subjects[]">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row mb-4" id="datepicker">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" class="form-control " name="software" autofocus value="{{old('software')}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
